...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tabbar-ruler" '("after-modifying-buffer" "last-tabbar-ruler-tabbar-buffer-groups" "on-" "tabbar-")))
